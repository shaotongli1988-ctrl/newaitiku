    ...
    def _default_managed_users(self) -> List[Dict[str, object]]:
        return [
            ...
            },
            {
                ...
                "managedJointExamGroupCodes": ["LITERATURE_1"],
                "createTime": self._now_iso(),
                "updateTime": self._now_iso(),
            },
            {
                ...
                "prepStage": "",
                "postTags": ["teach"],
                "managedStudentIds": ["student-003", "student-004"],
                "managedJointExamGroupCodes": ["SCIENCE_ENGINEERING_1"],
            },
            {
                "userId": "student-001",
                "role": ROLE_STUDENT,
                ...
                "mobile": "13800000004",
                "enabled": True,
                "permissions": self._default_permissions_for_role(ROLE_STUDENT),
                "examCategoryCode": "LITERATURE",
                "jointExamGroupCode": "LITERATURE_1",
                "vocationalMajor": "",
                "prepStage": "",
